      ...
      <div className="d-flex">
        ...
        <section className="home_contents">
          ...
          <div className="container presaleWrap mx-auto row">
            <div className="col-12 col-md-8 col-lg-8 col-xl-8  rightPresale">
              <div className="banner">
                ...
                <div className="bnSub">
                  ...
                  <p className="mt-4">
                    The adoption of blockchain-based platforms is still lagging
                    in most industries, despite the fact that an increasing
                    number of business sectors have begun utilizing this
                    technology. Decentralization, immutability, openness and
                    traceability are some of the blockchain's qualities that are
                    said to improve businesses as well as healthcare data
                    management, according to prior studies. However, most
                    sectors of business ecosystems have seen the official launch
                    of only a few blockchain projects. Many ideas are still in
                    the research and examination stages. To meet the need, we
                    have created ‘‘RMH Utility Token’’ Utility Token. Our
                    research and development of blockchain technologies help
                    businesses become more efficient while upgrading current
                    operating systems to run cheaper, faster and more secure.
                  </p>
                </div>
              </div>
            ...
            <div
              className="col-12 col-md-4 col-lg-4 col-xl-4 row "
